class EditorialsController < ApplicationController
  ...
  private
    ...
    def editorial_params
      params.require(:editorial).permit(:editorial_rut, :editorial_razon_social, :editorial_direccion, :editorial_email_contacto, :editorial_nombre_contacto, :editorial_descripcion)
    end
end
